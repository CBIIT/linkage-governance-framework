...
When appropriate, linking individual-level health data in ways that are secure, compliant and protect privacy allow researchers to accelerate discoveries for prevention, diagnostics, and treatments. The current biomedical research infrastructure lacks a common governance approach that supports linking data for research.  The Governance Framework for Linking Individual-level Health Data (Linkage Governance Framework) is a new model for governance that addresses the issues that can make it hard to link individual-level health data. This website discusses the governance challenges related to linking datasets, describes the framework and its Common Governance Process, and provides examples of how the framework could impact its prospective users.  
