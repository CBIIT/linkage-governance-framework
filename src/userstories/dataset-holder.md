...
- The {% glossary "rule_harmonization", glossary %} process revealed several conflicting and overlapping governance rules between the three datasets. The coordinating body proposed a harmonized approach to each of the overlaps and conflicts that could be hard for the investigator to negotiate on her own. 
